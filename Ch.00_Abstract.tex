...
Tähän tulee aikanaan yhden kappaleen eli n. 100 sanainen tiivistelmä. Tiivistelmässä käydään läpi mitä on tutkittu, miten on tuktittu ja mitä tuloksia on saatu.
