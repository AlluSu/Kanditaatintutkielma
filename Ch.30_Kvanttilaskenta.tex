...
Kuvaillaan seuraavaksi luvun $n$ jakamista tekijöihin Shorin algoritmin avulla:
\begin{enumerate}

    \item Valitaan satunnainen luku väliltä $x \in \{2, \ldots, n-1\}$
    
    \item Ovatko $x$ ja $n$ suhteellisia alkulukuja\footnote{ks. kappale 2.3} keskenään? Toisin sanoen jos $syt(x,n) = 1$, mennään kohtaan 3.
    
    \item Etsitään funktion $x^{a} \mod n$ jakso $r$, missä $a = \mathbb{N}$
