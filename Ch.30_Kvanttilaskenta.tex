...
Seuraavaksi käsittelemme kvanttilaskentaa ja sitä hyödyntäviä kvanttitietokoneita.
...
Simuloidaan nyt Eukleideen algoritmia pienellä syötteellä. Olkoon $n$ = 15 ja haluamme jakaa sen tekijöihin.
...
Toistaiseksi Shorin algoritmia ei ole saatu jakamaan tekijöihin kovin suuria lukuja johtuen laskentaan tarvittavasta suuresta resurssien määrästä (\cite{lopez2012}). Suurin luku joka on toistaiseksi saatu jaettua tekijöihin Shorin algoritmia käyttäen on 21. Shorin algoritmi on kuitenkin saatu skaalautuvaksi ja antaa luvun oikeat tekijät 99\% varmuudella. 1024-bittisen RSA-avaimen tekijöiden jakoon tarvittaisiin 2000-kubittinen kvanttitietokone (\cite{mavroeidis2018impact}).