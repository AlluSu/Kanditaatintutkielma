...
Seuraavaksi käsittelemme kvanttilaskentaa ja sitä hyödyntäviä kvanttitietokoneita. Lisäksi tutustumme Shorin algoritmin toimintaan ja miksi se uhkaa julkisen avaimen salausta.
...
joka on jaksollinen\footnote{Jaksollinen funktio tarkoittaa siis funktiota, joka toistuu samanlaisena tietyn jakson välein.} kun $x$ on suhteellinen alkuluku\footnote{ks. kappale 2.2.} $n$:n kanssa ja $n$ on nyt luku jonka haluamme jakaa tekijöihin. Koska $F(a)$ on jaksollinen niin sillä on tällöin jokin jakso $r$. 
\fi
