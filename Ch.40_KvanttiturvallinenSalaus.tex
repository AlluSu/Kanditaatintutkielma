...
Vaikka suuren koko luokan tehokkaat kvanttitietokoneet eivät vielä ole arkipäivää, tulisi kvanttiturvalliseen salaukseen varautua jo nyt. Kvanttitietokoneiden myötä on tullut uusi uhka nimeltään takautuva salauksen purku (\emph{Retrospective decryption}). Tämä tarkoittaa sitä, että joku hyökkäävä taho voi kerätä salattua dataa ja myöhemmin kvanttitietokoneiden yleistyessä purkaa datan. (\cite{ad93d053a85c4acebdd49cbe1a75d6bd}.)
