...
\usepackage{physics}         % Physics notations for quantum mechanics
...
\title{Kvanttiturvallinen salaus}
...
\supervisors{Prof.~Nikolaj Tatti, Prof.~Valtteri Niemi}

\keywords{Kvanttiturvallinen salaus, kvanttilaskenta, kvanttitietokoneet, salausjärjestelmät, kryptografia}
...
\\ \ Hardware $\rightarrow$ Emerging technologies $\rightarrow$ Quantum technologies $\rightarrow$ Quantum computation $\rightarrow$ Quantum communication and cryptography
}}
...
\hypersetup{
    ...
    pdftitle={Kvanttiturvallinen salaus},            % title
    pdfauthor={Aleksi Suuronen},           % author
    pdfsubject={Bachelor's thesis},          % subject of the document
    pdfcreator={Aleksi Suuronen},          % creator of the document
...
\include{Ch.20_Taustatiedot}
\include{Ch.30_Kvanttilaskenta}
\include{Ch.40_Kvanttiturvallinensalaus}
